...
(function () {
  ...
  document.querySelectorAll("#navmenu a").forEach((navmenu) => {
    ...
    document.addEventListener("DOMContentLoaded", function () {
      const text = "Kelola Masjid Lebih Mudah dengan Si Adam"; // Teks yang ingin ditampilkan
      ...
      fdocument.addEventListener("DOMContentLoaded", function () {
        ...
        function animateOnScroll() {
          ...
          const paragraphPos = paragraph.getBoundingClientRect().top;
          const windowHeight = window.innerHeight;

          if (headingPos < windowHeight) {
            heading.style.animationPlayState = "running";
          }

          if (paragraphPos < windowHeight) {
